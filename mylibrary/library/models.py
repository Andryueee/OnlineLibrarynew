...
class Author(models.Model):
    ...
    dateOfBirth = models.DateField(verbose_name='Дата рождения', blank=False, null=False)
...
class Book(models.Model):
    title = models.CharField(max_length=100, verbose_name='Название книги', blank=False, unique=False, default='Unknown Title')
    author = models.ForeignKey(Author, on_delete=models.CASCADE, verbose_name='Автор', blank=False, null=True)
    yearOfRel = models.IntegerField(verbose_name='Год выпуска', blank=False, default=2023, validators=[MinValueValidator(1000), MaxValueValidator(9999)])
